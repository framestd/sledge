...
class Indexer:
    ...
    CREATE_TABLE = """CREATE TABLE IF NOT EXISTS deps_index
                        (id INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT,
                        dfile TEXT NOT NULL, ifiles TEXT NOT NULL)"""
    INSERT_INTO = """INSERT INTO deps_index VALUES (NULL, ?, ?)"""
    ...
    class Writer:
        ...
        def write_index(self, *ifiles):
            ...
            try:
                self.this.cur.execute(Indexer.INSERT_INTO, (self.this.dependent_file, files))
